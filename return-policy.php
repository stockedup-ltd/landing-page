...
<title>Return Policy | StockedUp</title>
...
<section class="legal-content">
  <h1>StockedUp Return Policy</h1>
  <span class="effective-date">Effective Date: 4th May, 2026</span>
  <p>At StockedUp, we aim to ensure a smooth and satisfying shopping experience.</p>
  
  <h2>1. Perishable Goods</h2>
  <p>Due to the nature of food items:</p>
  <ul>
    <li>Most items are non-returnable once delivered</li>
    <li>Returns are only accepted if items are:
      <ul>
        <li>Damaged</li>
        <li>Spoiled</li>
        <li>Incorrect</li>
  ...
  <h2>2. Reporting Issues</h2>
  <p>Customers must report issues:</p>
  <ul>
    <li>Within 24 hours of delivery</li>
    <li>With clear photo/video evidence</li>
  </ul>
  <p>Send complaints to:<br>📧 <a href="mailto:support@stockedup.africa">support@stockedup.africa</a></p>
  
  <h2>3. Resolution Options</h2>
