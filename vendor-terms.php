...
<title>Vendor Terms & Conditions | StockedUp</title>
...
<section class="legal-content">
  <h1>StockedUp Vendor Terms & Conditions</h1>
  <span class="effective-date">Effective Date: 4th May, 2026</span>
  <p>These terms apply to all vendors on StockedUp.</p>
  ...
  <ul>
    ...
    <li>StockedUp may charge a commission per order (to be agreed)</li>
  </ul>
  ...
  <h2>7. Payments</h2>
  <p>Vendors will receive payments based on agreed payout schedule</p>
